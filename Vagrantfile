...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  #carpeta compartida
  config.vm.synced_folder "shared", "/home/vagrant/shared", owner: "vagrant", group: "vagrant", create: false
  config.vm.synced_folder "wordpress", "/var/www/html/wordpress", owner: "www-data", group: "www-data", create: true
